...
/* note: underlined tabs must be drawn as underlined space "leaders" */
			...
			OpusSetPp(char, pchr, (char *)*vhgrpchr + bchrCur);
			OpusSetPp(char, pchp, (char *)*vhgrpchr + bchpCur);
			OpusAdvPp(struct CHRT, pchr, 1);
			}

...
#ifdef OPUS_X64
/* Counted strings normally produced by the missing localization pass. */
csconst CHAR mpifmtstFormat[][21] =
{
	{ 18, 'N', 'o', 'r', 'm', 'a', 'l', ' ', 'W', 'o', 'r', 'd', ' ',
		'f', 'o', 'r', 'm', 'a', 't' },
	{ 20, 'W', 'o', 'r', 'd', ' ', 't', 'e', 'm', 'p', 'l', 'a', 't', 'e',
		' ', 'f', 'o', 'r', 'm', 'a', 't' },
	{ 10, 'p', 'l', 'a', 'i', 'n', ' ', 't', 'e', 'x', 't' },
};
#else
